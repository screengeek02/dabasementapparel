...
export default function ProductCard({
  ...
  return (
    <div
      ...
      className="cursor-pointer bg-zinc-950 border border-zinc-800 rounded-2xl overflow-hidden flex flex-col hover:border-baseRed hover:-translate-y-1 hover:shadow-lg transition"
    >
